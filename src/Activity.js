     ...
     return(
      <div className="activity-container">
          <div className="activity-container__item">
               <h3> {props.name} - {props.hour < 10 ? "0" + props.hour : props.hour}:{props.minute < 10 ? "0" + props.minute : props.minute} || {props.dayPlanned}-{props.monthPlanned}-{props.yearPlanned} </h3>
